package se.moosetrail.skola.edan20.labbar.assignment4.format;

import se.moosetrail.skola.edan20.labbar.assignment4.Triple;
import se.moosetrail.skola.edan20.labbar.assignment4.TripleStore;
 ...
 */
// The class to load a CONLL corpus 2006 and 2007 and format it into a list.
public class CONLLCorpus {
    ...
    public static void main(String[] args) throws IOException {
        ...
        List<List<Word>> sentenceList = trainingCorpus.loadFile(trainingSet);

        TripleStore tripleStore = new TripleStore();
        TripleStore doubleStore = new TripleStore();
        ...
        for (List<Word> sentence : sentenceList) {
            for (Word word : sentence) {
                if (word.getDeprel().equals("SS")) {
                    ...
                    Triple d = new Triple(subject, verb);
                    doubleStore.add(d);
        ...
        System.out.println("The number of pairs of doubles found was: " + doubleStore.countTriplets());
        System.out.println("The number of pairs of triples found was: " + tripleStore.countTriplets());
