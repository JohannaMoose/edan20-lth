package se.moosetrail.skola.edan20.labbar.assignment5.parser;
...
import se.moosetrail.skola.edan20.labbar.assignment5.format.Word;
import se.moosetrail.skola.edan20.labbar.assignment5.format.ARFFData;
import se.moosetrail.skola.edan20.labbar.assignment5.format.CONLLCorpus;
import se.moosetrail.skola.edan20.labbar.assignment5.format.Constants;
import se.moosetrail.skola.edan20.labbar.assignment5.guide.Features;
...
public class ReferenceParser {
    ...
    ReferenceParser(List<Word> wordList) {
        stack = new Stack<>();
        queue = new ArrayList<>(wordList);
        this.wordList = wordList;
        depGraph = new ArrayList<>();
    }
